                  ...
                  <div class="limit-box">
                    <nav class="main-menu ">
                      <ul class="menu-area-main">
                        ...
                        <li> <a href="#important">Admission</a> </li>
                  ...
                  <div class="row">
                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                      <div class="text-bg">
                        ...
                        <p>Greatest gift to your children is education</p>
                        <a href="#">Read more</a><a href="#">get a qoute</a>
                      </div>
                    </div>
              ...
              <div class="container-fluid padding_dd">
                <div class="carousel-caption ">
                  <div class="row">
                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                      <div class="text-bg">
                        <h1>ENVIRONMENT THAT PROMOTES LEARNING</h1>
                        <p>Suitable Environment to promote learning</p>
                        <a href="#">Read more</a> <a href="#">get a qoute</a>
                      </div>
                    </div>
                    <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
          <div class="about-box">
            ...
            <p style="text-align:left"> As one of the best schools in Port Harcourt, Oak Breed International school
              ...
              security. The security post is located close to the front gate. Everyday there are two security officers
              waiting at their post. The school is arranged in a square shape. In the centre, you will see a wide open
              area with a flag pole. The area is used for flag raising ceremony and also for sports activity as well as
              other outdoor activities. The headmaster’s office is located not far from the entrance gate alongside the
              administration staff office and teachers’ hall. There are 24 classrooms at this school. </p>
          ...
          <div class="box_bg">
            <div class="box_bg_img">
              <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="box_my">
                    <figure><img src="images/ois-nursery.jpg"></figure>
                    <div class="overlay">
                      <h3>NURSERY</h3>
                      <p>It is a long established fact that a reader will be distracted by the readable content o</p>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="box_my">
                    <figure><img src="images/ois-primary.jpg"></figure>
                    <div class="overlay">
                      <h3>PRIMARY</h3>
                      <p>It is a long established fact that a reader will be distracted by the readable content o</p>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="box_my">
                    <figure><img src="images/ois-middle-school.jpg"></figure>
                    <div class="overlay">
                      <h3>JS1-JS3</h3>
                      <p>It is a long established fact that a reader will be distracted by the readable content o</p>
                    </div>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 border_left" style="text-align:left">
          <div class="box_text">
            ...
            <p>The parents are requested to visit the school Admission Office, fill out the registration form and
              ...
              of the same, fill in the details and submit the hard copy of the completed form to the school.Parents /
              Guardians are invited to visit the school campus to understand the culture and ethos of the Institution
              The parent needs to fill up the admission form and ensure all documents are in order. Kindly intimate the
              school in case your child requires some special assistance due to any health reasons.
            </p>
            <!-- <a href="Javascript:void(0)">Read more</a> -->
          </div>
        </div>
        ...
        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
          <div class="titlepage">
            ...
            <span>Oakbreed International School believes there is more to life than academic success. We actively uphold
              ...
              classroom. We believe that learning is a lifelong process that occurs both in and out of the
              classroom.Thoughtful and motivated counselors, teachers, and administrators work with students and their
              families to ensure that all students have the opportunity to reach their full potential at TMS.</span>
          </div>
        </div>
  ...
  <div class="make">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="titlepage">
            <h2>Make Your <strong class="white_colo">Children Standout</strong></h2>
          </div>
        </div>
      </div>
      <div class="row">
  ...
  <div id="contact" class="contact">
    ...
    <footer>
      <div class="footer ">
              ...
              <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 ">
                  <div class="address">
                    ...
                    <ul class="loca">
                      <li>
                        <a href="#"><img src="icon/loc.png" alt="#" /></a>Road 24 Extension A by Chief Jephtah Close
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="address">
                    ...
                    <ul class="Menu_footer">
                      <li class="active"> <a href="#">We have Safe and Secured Environment</a> </li>
                      <li><a href="#">Fully Qualified and Caring Staff</a> </li>
                      <li><a href="#">Serene Academic environment</a> </li>
                      <li><a href="#">Child Centered Learning</a> </li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 ">
                  <div class="address">
                    <a href="index.html"> <img src="images/ois-logo-1.png" alt="logo"></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="copyright">
          <div class="container">
            <p>Copyright © 2021 Design by <a href="https://html.design/">Anitor Abraham </a></p>
          </div>
        </div>
      </div>
    </footer>
