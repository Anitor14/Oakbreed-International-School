      ...
      <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
          <div class="about-box">
            ...
            <p> orem ipsum dolor sit amet, consectetur adipisicing elit. Quas voluptatem maiores eaque similique non
              distinctio voluptates perspiciatis omnis, repellendus ipsa aperiam, laudantium voluptatum nulla?.
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta, assumenda, vo
              luptatum. Libero eligendi molestias iure error animi totam laudantium, aspernatur similique id eos at
              consectetur illo culpa, </p>
    ...
    <div class="container-fluid padding_left3">
      <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 border_right">
          <div class="box_text">
            <div class="titlepage">
              <h2>Admission <strong class="yellow"> Process</strong></h2>
            </div>
  ...
  <div id="learn" class="learn">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
          <video width="650" height="240" autoplay muted>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <span>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of
                ...
                professor at Hampden-Sydney College in </span>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
              <div class="row">
